...
fileprivate let kAlertActionHeight: CGFloat = 50
...
open class PMAlertController: UIViewController {
    ...
    public convenience init(title: String?, description: String?, image: UIImage? = nil) {
        self.init()
...
//        }
    ...
    fileprivate func configureViews(){
        ...
        alertView.backgroundColor = UIColor(hex: 0xF2F2F2)
        
        alertTitle.textColor = AppColors.colorPrimary
        alertTitle.font = AppFonts.bodySemiBold
