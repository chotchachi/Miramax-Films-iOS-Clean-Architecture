//
//  PersonWishlistCollectionViewCell.swift
//  Miramax Fillms
//
...
class PersonWishlistCollectionViewCell: UICollectionViewCell, UIGestureRecognizerDelegate {
...
extension PersonWishlistCollectionViewCell {
...
fileprivate extension UICollectionView {
    ...
    var openingCell: PersonWishlistCollectionViewCell? {
        get {
            return objc_getAssociatedObject(self, &AssociatedKeys.currentcell) as? PersonWishlistCollectionViewCell
        }
        set {
            if let newValue = newValue {
                objc_setAssociatedObject(
                    ...
                    newValue as PersonWishlistCollectionViewCell?,
